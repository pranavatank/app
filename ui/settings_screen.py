...
class SettingsScreen(QWidget):
    ...
    def _section_security(self) -> QGroupBox:
        ...
        self.totp_checkbox.setAccessibleName("Enable two-factor authentication")
        self.totp_checkbox.setAccessibleDescription("Enable time-based one-time password authentication using Google Authenticator or similar.")
    ...
    def _section_privacy(self) -> QGroupBox:
        ...
        self.privacy_checkbox.setAccessibleName("Privacy mode")
        self.privacy_checkbox.setAccessibleDescription("Mask all financial amounts with (₹ ****) to protect sensitive data. Changes apply immediately.")
